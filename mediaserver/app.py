...
def create_app() -> Flask:
    ...
    def delete(asset_id):
        ...
        try:
            # Mobile cleanup must use the same ownership checks and lock as its worker.
            ...
            if mobile_asset is None:
                ...
                with MOBILE_UPLOAD_REGISTRY.upload_operation_lock(
                    mobile_asset.upload_id
                ):
                    MOBILE_ASSET_STORE.delete_committed(mobile_spec)
        except (OSError, MobileMediaAssetError):
